        ...
        If .bEnabled = True Then 'Make sure it is enabled
            ...
            Else
                ...
                ElseIf .bUseOptionBox Then
                    ...
                    If (X > 1 And X < b.Right) And (Y > b.Top And Y < b.Bottom) Then
                        If .iOpt = 0 Then 'If it isn't selected,
...
bBNeedSB = DoINeedaVSB
If UBound(aList) <= DeterVisible(bBNeedSB) Then lTop = 1
...
Select Case KeyCode
    ...
    Case vbKeyUp
        ...
        End If
    Case 32
        If aList(lSelected).bUseCheckBox Or aList(lSelected).bUseOptionBox Then
            With aList(lSelected)
                If .bUseCheckBox Then
                    Select Case .iCheck
                        Case 0
                            .iCheck = 1 'Check it
                            RaiseEvent ItemChecked(lSelected)
                        Case 1
                            .iCheck = 0 'UnCheck it
                    End Select
                ElseIf .bUseOptionBox Then
                    If .iOpt = 0 Then
                        For j = 1 To UBound(aList)
                            With aList(j)
                                If .bUseOptionBox Then
                                    If .lOptionGroup = aList(lSelected).lOptionGroup Then
                                        .iOpt = 0
                                    End If
                                End If
                            End With
